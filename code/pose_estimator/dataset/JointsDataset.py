...
from pose_utils.transforms import get_affine_transform, affine_transform, get_scale
from pose_utils.cameras import project_pose_cpu
...
class JointsDataset(Dataset):
    ...
    def _rebuild_db(self):
        for idx in range(len(self.db)):
            ...
            if 'pred_pose2d' in db_rec.keys():
                meta['pred_pose2d'] = db_rec['pred_pose2d']
    ...
    def __getitem__(self, idx):
        ...
        if self.input_heatmap_src == 'image':
            ...
            assert 'pred_pose2d' in db_rec['meta'] and db_rec['meta']['pred_pose2d'] is not None, 'Dataset must provide pred_pose2d'
            all_preds = db_rec['meta']['pred_pose2d']
            input_heatmaps = []
